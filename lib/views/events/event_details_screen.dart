...
class _EventDetailsScreenState extends State<EventDetailsScreen> {
      ...
      if (mounted) {
        setState(() {
          _event = details.copyWith(
            ...
            isRegistered: isReg,
            isSaved: widget
                .isSaved, // Keep passed state or assume false if not fetched
  ...
  Future<void> _unregister() async {
    try {
      ...
      if (success) {
        setState(() {
          _isRegistered = false;
          _event.totalRegistrations = (_event.totalRegistrations - 1).clamp(
            0,
            999999,
          );
        });
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text("Failed to unregister")));
      }
    }
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _infoRow(
                        ...
                        'Date and Time',
                        '${_event.startDate} Â· ${_event.startTime}',
                      ),
                      _infoRow(
                        theme,
                      ...
                      _infoRow(
                        ...
                        'Attendees',
                        '${_event.totalRegistrations} going',
                      ),
                      const SizedBox(height: 32),
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _organizerItem(
                              ...
                              _event.organizerName ?? 'Organizer',
                            ),
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => MyEventAnalyticsScreen(event: _event),
              ),
            );
          },
  ...
  Widget _infoRow(ThemeData theme, IconData icon, String title, String sub) =>
      Padding(
